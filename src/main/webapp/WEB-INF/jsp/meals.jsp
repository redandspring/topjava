...
<section>
    ...
    <form method="post" action="${root}meals/filter">
        <dl>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${root}meals/update?id=${meal.id}"><spring:message code="meals.update"/></a></td>
                <td><a href="${root}meals/delete?id=${meal.id}"><spring:message code="meals.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
